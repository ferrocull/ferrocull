...
The system explicitly rejects Photo Mechanic's dated chrome (2005-era clutter and dialog soup), trendy web-app gloss (glassmorphism, gradients, marketing polish), and the bare unstyled GTK/Qt utility look. Warmth is deliberate and photographic, never decorative.
...
### Don't:
- **Don't** recreate Photo Mechanic's dated chrome — no dialog soup, no 2005-era visual clutter, even when copying its workflow.
